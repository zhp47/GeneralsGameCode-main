...
// Your renderer backend will need to support it (most example renderer dx8_backend support both 16/32-bit indices).
// Another way to allow large meshes while keeping 16-bit indices is to handle ImDrawCmd::VtxOffset in your renderer.
// Read about ImGuiBackendFlags_RendererHasVtxOffset for details.
//#define ImDrawIdx unsigned int

//---- Override ImDrawCallback signature (will need to modify renderer dx8_backend accordingly)
//struct ImDrawList;
//struct ImDrawCmd;
